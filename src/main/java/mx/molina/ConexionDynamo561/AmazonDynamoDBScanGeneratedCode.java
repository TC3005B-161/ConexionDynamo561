package mx.molina.ConexionDynamo561;
 ...
 */
public class AmazonDynamoDBScanGeneratedCode {
    ...
    private static AmazonDynamoDB createDynamoDbClient(String region) {
        // Use the following builder instead when using DynamoDB Local
         ...
         new AWSStaticCredentialsProvider(new BasicAWSCredentials("4m0p2", "usveid"))
         )
         .build();
    ...
    private static ScanRequest createScanRequest() {
        ...
        scanRequest.setTableName("Employee");
